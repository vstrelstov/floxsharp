...
type ScannerTests () =
    ...
    member this.ScanSingleTokens () =
        ...
        let expected = [TokenType.LeftParen; TokenType.LeftBrace; TokenType.Star; TokenType.Minus; TokenType.Plus; TokenType.Dot; TokenType.Semicolon; TokenType.RightBrace; TokenType.Comma; TokenType.EOF]
    ...
    member this.ScanDoubleTokens () =
        let source = ">= <= !=       =="
        let actual = getTokenTypes source
        let expected = [TokenType.GreaterEqual; TokenType.LessEqual; TokenType.BangEqual; TokenType.EqualEqual; TokenType.EOF]
        Assert.AreEqual(expected, actual)
    ...
    member this.ScanSingleAndDoubleTokens () =
        let source = "=== =<="
        let actual = getTokenTypes source
        let expected = [TokenType.EqualEqual; TokenType.Equal; TokenType.Equal; TokenType.LessEqual; TokenType.EOF]
        Assert.AreEqual(expected, actual)
    ...
    member this.ScanString () =
        ...
        let expected = [(TokenType.String, "asdf\nght"); (TokenType.String, "qwer"); (TokenType.EOF, "")]
        Assert.AreEqual(expected, actual)
    ...
    member this.ScanKeywords () =
        ...
        let actual = getTokenTypes source
        let expected = [TokenType.Var; TokenType.While; TokenType.Nil; TokenType.Or; TokenType.And; TokenType.For; TokenType.Comment; TokenType.EOF]
        Assert.AreEqual(expected, actual)
